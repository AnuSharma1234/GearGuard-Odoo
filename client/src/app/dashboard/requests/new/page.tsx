      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-2xl font-semibold text-white">New Maintenance Request</h1>
          </div>
          <p className="text-[#666666] text-sm ml-8">Create a new maintenance request for equipment</p>
        </div>
